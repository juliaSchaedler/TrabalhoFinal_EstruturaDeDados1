...
// ordenação o quicksort, que leva ponteiros nos lugar de vetores
...
/* Considera o último elemento como pivo e coloca esse elemento-pivo no lugar
 * correto da lista, e coloca dos os elementos menores que o pivo na esquerda e
 * os maiores na direita */
